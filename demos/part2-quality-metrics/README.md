...
### Clonar ColorVideoVDP

En el root del repositorio, ejecuta:

```bash
git submodule update --init --recursive
```

Luego ejecuta el instalador correspondiente a tu sistema operativo.
...
>
> ⚠️ **Nota:** Si tenes una tarjeta gráfica NVIDIA, el script instalará PyTorch con soporte CUDA,
> lo que descarga aproximadamente **2.5 GB** (Al terminar la demo podes borrar el venv si querés)
...
**Windows:**
```cmd
demos\part2-quality-metrics\ColorVideoVDP\venv\Scripts\activate
cd demos\part2-quality-metrics\ColorVideoVDP
```
...
## ✅ Parte 2 — Verificación del entorno
...
Antes de ejecutar la métrica, abre la carpeta `demos/part2-quality-metrics/assets/` y **reproduce los videos** con tu reproductor favorito. Familiarízate con lo que vas a analizar:
...
## 🔬 Parte 3 — Ejercicio A: Comparación de calidad

### Premisa

Imagina que estás evaluando dos clips con artefactos. Tu trabajo: determinar cuáles son los artefactos y su naturaleza.
...
Estando dentro de la carpeta `demos/part2-quality-metrics/`, ejecuta:
...
- ¿Coincide con tu impresión visual?
...
## 🗺️ Parte 4 — Ejercicio B: Análisis visual con heatmaps y distogramas
...
- **Naranja / amarillo** → Distorsión moderada. Algunos observadores la notarán, otros no.
- **Amarillo Fuerte** → **Alerta máxima.** El 100% de los usuarios va a notar un defecto evidente en esa zona.

> 💡 Lo clave: un heatmap todo azul = calidad perceptualmente perfecta, aunque el archivo tenga diferencias a nivel de píxel.
...
## 🖥️ Parte 5 — Bonus: Cambiar el display
